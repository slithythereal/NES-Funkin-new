...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		changeModeText.setFormat(Paths.font("Pixel_NES.otf"), 32, FlxColor.WHITE, CENTER);
	...
	function createTexts()
	{
		for (i in 0...4)
		{
			...
			text.setFormat(Paths.font("Pixel_NES.otf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
